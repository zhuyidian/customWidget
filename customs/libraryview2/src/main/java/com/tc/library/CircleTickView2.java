...
public class CircleTickView2 extends View {
    //===================整体
    ...
    public CircleTickView2(Context context) {
        this(context, null);
        Log.v("circleTick", "---CircleTickView---1");
        init(context, null);
    }
    public CircleTickView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        //setWillNotDraw(false);  //更换成ＶiewGroup后不执行OnDraw
        Log.v("circleTick", "---CircleTickView---2");
        init(context, attrs);
    }
    public CircleTickView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        try {
            TypedArray attr = context.obtainStyledAttributes(attrs, R.styleable.CircleTickView2);

            //整体
            mCircleRadius = attr.getInt(R.styleable.CircleTickView2_circleRadius, 200);
            if(fixCircleRadius>0){
                mCircleRadius = fixCircleRadius;
            }
            mTickMaxCount = attr.getInt(R.styleable.CircleTickView2_tickMaxCount, 31);
            touchPrecision = attr.getInt(R.styleable.CircleTickView2_touchPrecision, 5);
            mRoundBackgroundColor = attr.getColor(R.styleable.CircleTickView2_roundBackgroundColor, getResources().getColor(R.color.gray_c));
            //big
            mLineWidthBig = attr.getFloat(R.styleable.CircleTickView2_lineWidthBig, 0.3f);
            mDefaultTickColorBig = attr.getColor(R.styleable.CircleTickView2_defaultTickColorBig, getResources().getColor(R.color.purple_83));
            mTickStrokeSizeBig = attr.getDimensionPixelSize(R.styleable.CircleTickView2_tickStrokeSizeBig, getDpValue(20));
            //small
            mLineWidthSmall = attr.getFloat(R.styleable.CircleTickView2_lineWidthSmall, 0.3f);
            mDefaultTickColorSmall = attr.getColor(R.styleable.CircleTickView2_defaultTickColorSmall, getResources().getColor(R.color.purple_82));
            mDefaultTickColorSmallDynamic = mDefaultTickColorSmall;
            mTickStrokeSizeSmall = attr.getDimensionPixelSize(R.styleable.CircleTickView2_tickStrokeSizeSmall, getDpValue(20));
            //Triangle
            mDefaultTriangleColor = attr.getColor(R.styleable.CircleTickView2_defaultTriangleColor, getResources().getColor(R.color.gray_c));
            //other
            mCenterTextColor = attr.getColor(R.styleable.CircleTickView2_centerTextColor, getResources().getColor(R.color.purple_83));
            mCenterTextSize = attr.getDimension(R.styleable.CircleTickView2_centerTextSize, getSpValue(50));
            mValue = attr.getInt(R.styleable.CircleTickView2_value,1);
